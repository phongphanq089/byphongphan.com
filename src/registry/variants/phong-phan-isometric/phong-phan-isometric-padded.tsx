...
export function PhongPhanIsometricPadded() {
  return (
    <div className="flex min-h-[320px] w-full items-center justify-center overflow-hidden rounded-xl border border-border/80 bg-accent p-6 shadow-xs select-none">
