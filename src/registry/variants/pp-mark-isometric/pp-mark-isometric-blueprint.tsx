...
export function PPMarkIsometricBlueprint() {
  return (
    <div className="relative flex min-h-[360px] w-full items-center justify-center overflow-hidden rounded-xl border border-sky-500/20 bg-[#071322] p-6 shadow-xs select-none">
