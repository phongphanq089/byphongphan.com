...
export function PPMarkIsometricWireframe() {
  return (
    <div className="flex min-h-[360px] w-full items-center justify-center overflow-hidden rounded-xl border border-border/80 bg-[#0a0a0c] p-6 shadow-xs select-none">
