...
// Individual pill-button — dark glass active state, not generic grey
function FloatBtn({
  children,
  active = false,
  title,
  ...
  return (
    <button
      ...
      title={title}
      className={[
        "relative inline-flex size-6 items-center justify-center rounded-md transition-all duration-100",
        active
...
function FloatDivider() {
  return (
    <span className="mx-0.5 h-3.5 w-px shrink-0 rounded-full bg-border/60" />
  )
}
...
export function FloatingToolbarPlugin({
  ...
  return createPortal(
    <div
      ...
      className="editor-float-panel fixed z-50 flex animate-in items-center gap-0 px-1 py-1 duration-100 fade-in-0 zoom-in-95"
