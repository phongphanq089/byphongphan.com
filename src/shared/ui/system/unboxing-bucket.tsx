  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ─── Layer 1: Background Box Flaps (Behind the animated chip) ─── */}
        <svg
          width="100%"
          height="100%"
          viewBox="0 0 655 352"
        ...
        {/* ─── Layer 2: Animated Floating Chip (Sandwiched in the middle) ─── */}
        ...
        {/* ─── Layer 3: Foreground Box Body (Front face covering the lower chip) ─── */}
        <svg
          width="100%"
          height="100%"
          viewBox="0 0 655 352"
